...
import { deleteFetcher, postWithFormDataFetcher, putFetcher, putWithFormDataFetcher } from '../services/api'
import { dirtyInput, isResponseErrorObject } from '../services/helpers'
import useAuth from './useAuth'

export default function useArticle({ mutate }) {
    ...
    async function onSubmitDelete() {
        try {
            await deleteFetcher('/api/content/article', editId)
            mutate()
    ...
    async function onSubmitForm(data) {
        try {
            if (isEdit) {
                ...
                await putWithFormDataFetcher('/api/content/article', editId, formData)
                mutate()
                ...
                await postWithFormDataFetcher('/api/content/article', formData)
                mutate()
