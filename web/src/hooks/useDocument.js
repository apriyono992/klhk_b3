...
export default function useDocument({ mutate }) {
    ...
    async function onSubmitDelete() {
        try {
            await deleteFetcher('/api/content/document', editId)
            mutate()
    ...
    async function onSubmitForm(data) {
        try {
            if (isEdit) {
                ...
                await putWithFormDataFetcher('/api/content/document', editId, formData)
                mutate()
                ...
                await postWithFormDataFetcher('/api/content/document', formData)
                mutate()
                toast.success('Dokumen berhasil ditambah!')
            }
            onCloseForm()
        } catch (error) {
