...
import useTujuanBongkar from "../../../hooks/useTujuanBongkar";
...
export default function IndexPage() {
    ...
    const { data, isLoading, mutate } = useSWR(selectedCompany ? `/api/company/search-perusahaan-tujuan-bongkar?page=${page + 1}&limit=${pageSize}&companyId=${selectedCompany}` : null, getFetcher);
    console.log(data);
    const { 
        isEdit,
        onClickEdit, 
    ...
    return(
        <RootAdmin>
            <Card className="w-full mt-3" radius="sm">
                <CardHeader>
                    <p className="text-md">Daftar Tujuan Bongkar</p>
                </CardHeader>
                <Divider />
            ...
            <Modal size="2xl" scrollBehavior="inside" isOpen={isOpenModalForm} onOpenChange={onOpenChangeModalForm} onClose={onCloseForm} isDismissable={false} isKeyboardDismissDisabled={false}>
                <ModalContent>
                    {(onClose) => (
                        <>
                            <ModalHeader>{isEdit ? 'Ubah' : 'Tambah'} Tujuan Bongkar</ModalHeader>
                            <ModalBody>
                                    ...
                                    {isEdit && !dataVillage 
                                        ...
                                        <>
                                            <div className='grid grid-cols-2 gap-3 mb-6'>  
                                                ...
                                                <ControlledInput label="Nama Perusahaan Tujuan Bongkar" name="namaPerusahaan" type="text" isRequired={true} control={control} />
