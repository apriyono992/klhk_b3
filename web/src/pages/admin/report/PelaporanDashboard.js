...
export default function PelaporanDashboard() {
        ...
        <RootAdmin>
            <Card className="w-full" radius="sm">
                ...
                <CardBody className="w-full h-[550px] p-5">
                    <Tabs aria-label="Pelaporan B3" defaultValue="reportedCompanies">
                        <Tab title="Perusahaan Sudah Melapor" value="reportedCompanies">
                            <CustomDataGrid
                        ...
                        <Tab title="Perusahaan Belum Melapor" value="unreportedCompanies">
                            <CustomDataGrid
                        ...
                        <Tab title="Rekomendasi Sudah Melapor" value="reportedApplications">
                            <CustomDataGrid
                        ...
                        <Tab title="Rekomendasi Belum Melapor" value="unreportedApplications">
                            <CustomDataGrid
                                data={unreportedApplications?.data || []}
                                rowCount={unreportedApplications?.total || 0}
                                columns={columns}
                                pageSize={pageSize}
                                setPageSize={setPageSize}
                                page={page}
                        ...
                        <Tab title="Registrasi Sudah Melapor" value="reportedRegistrations">
                            <CustomDataGrid
                        ...
                        <Tab title="Registrasi Belum Melapor" value="unreportedRegistrations">
                            <CustomDataGrid
                                data={unreportedRegistrations?.data || []}
                                rowCount={unreportedRegistrations?.total || 0}
                                columns={columns}
                                pageSize={pageSize}
                                setPageSize={setPageSize}
                                page={page}
