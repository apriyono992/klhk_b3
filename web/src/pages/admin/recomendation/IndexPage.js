    ...
    return(
        <RootAdmin>
            <Card className="w-full mt-3">
                <CardHeader>
                    <p className="text-md">Daftar Rekomendasi B3</p>
                </CardHeader>
                <Divider />
                <CardBody>
                    <div>
                        <Button startContent={<DocumentPlusIcon className="size-4"/>} size="sm" color="primary"><Link to="/admin/rekomendasi-b3/tambah">Tambah</Link></Button>
                    </div>
                                    ...
                                    <TableCell>
                                        <div className="relative flex justify-end items-center gap-2">
                                            <Dropdown radius="sm" size="sm" className="bg-background border-1 border-default-200">
                                                ...
                                                <DropdownMenu>
                                                    <DropdownItem startContent={<EyeIcon className="size-4"/>}><Link to="/admin/rekomendasi-b3">Detail</Link></DropdownItem>
                                                </DropdownMenu>
                                            </Dropdown>
                                        </div>
                                    </TableCell>
