      ...
      <div className="relative">
        ...
        <div className="absolute top-[10%] flex flex-col justify-center text-white px-28 space-y-4">
          <p className="text-4xl md:text-6xl font-bold">
            Menuju Indonesia Maju dengan 
          </p>
          <p className="text-4xl md:text-6xl font-bold pb-8">
            Lingkungan Lestari 
          </p>
          <p className="text-lg md:text-xl max-w-[60%]">
            Kementerian LHK berkomitmen mewujudkan pembangunan lingkungan hidup dan kehutanan secara berkelanjutan dalam meningkatkan kesejahteraan rakyat menuju Indonesia Maju
          </p>
        </div>
        <div className="absolute left-1/4 -mt-16 md:-mt-32 z-10 mx-auto max-w-5xl p-4">
          <div className="grid grid-cols-2 md:grid-cols-6 gap-6 bg-white bg-opacity-90 text-center p-6 rounded-lg shadow-lg">
            {icon.map(data => (
                ...
                <span className="text-3xl"><img src={data.icon}/></span>
        ...
        <div className="px-20 pt-8">
            <p className="text-4xl text-[#05472A] mb-7">
                Berita Terkini
            </p>
