...
-- */
-- -- Drop Foreign Key jika ada pada PelaporanB3Dihasilkan
-- DO $$
-- BEGIN
--     IF EXISTS (
--         SELECT 1
--         FROM information_schema.table_constraints
--         WHERE constraint_name = 'PelaporanB3Dihasilkan_dataBahanB3Id_fkey'
--     ) THEN
--         ALTER TABLE "PelaporanB3Dihasilkan" DROP CONSTRAINT "PelaporanB3Dihasilkan_dataBahanB3Id_fkey";
--     END IF;
-- END $$;

-- -- Drop Foreign Key jika ada pada PerusahaanAsalMuat
-- DO $$
-- BEGIN
--     IF EXISTS (
--         SELECT 1
--         FROM information_schema.table_constraints
--         WHERE constraint_name = 'PerusahaanAsalMuat_pengangkutanDetailId_fkey'
--     ) THEN
--         ALTER TABLE "PerusahaanAsalMuat" DROP CONSTRAINT "PerusahaanAsalMuat_pengangkutanDetailId_fkey";
--     END IF;
-- END $$;

-- -- Drop Foreign Key jika ada pada PerusahaanTujuanBongkar
-- DO $$
-- BEGIN
--     IF EXISTS (
--         SELECT 1
--         FROM information_schema.table_constraints
--         WHERE constraint_name = 'PerusahaanTujuanBongkar_pengangkutanDetailId_fkey'
--     ) THEN
...
-- -- AlterTable
-- ALTER TABLE "Company" ADD COLUMN IF NOT EXISTS "skalaPerusahaan" TEXT;


-- -- AlterTable
-- ALTER TABLE "`DataCustomer`" DROP COLUMN  IF EXISTS   "namaSupplier",
