/*
  ...
  - You are about to drop the column `finalisasiPada` on the `LaporanPengangkutanFinal` table. All the data in the column will be lost.
  - You are about to drop the column `perusahaanId` on the `LaporanPengangkutanFinal` table. All the data in the column will be lost.
  - You are about to drop the column `totalJumlahB3` on the `LaporanPengangkutanFinal` table. All the data in the column will be lost.
  ...
  - A unique constraint covering the columns `[applicationId,companyId,bulan,tahun]` on the table `LaporanPengangkutanFinal` will be added. If there are existing duplicate values, this will fail.
  ...
  - Added the required column `approvedAt` to the `LaporanPengangkutanFinal` table without a default value. This is not possible if the table is not empty.
  - Added the required column `companyId` to the `LaporanPengangkutanFinal` table without a default value. This is not possible if the table is not empty.
  - Added the required column `periodId` to the `LaporanPengangkutanFinal` table without a default value. This is not possible if the table is not empty.
  - Added the required column `vehicleId` to the `LaporanPengangkutanFinal` table without a default value. This is not possible if the table is not empty.
  - Added the required column `updatedAt` to the `LaporanPengangkutanFinalDetail` table without a default value. This is not possible if the table is not empty.
...
*/
-- DropForeignKey
ALTER TABLE "LaporanPengangkutanFinal" DROP CONSTRAINT "LaporanPengangkutanFinal_perusahaanId_fkey";
...
-- DropIndex
DROP INDEX "LaporanPengangkutanFinal_applicationId_perusahaanId_bulan_t_key";

-- AlterTable
ALTER TABLE "Company" ADD COLUMN     "districtId" TEXT,
ADD COLUMN     "latitude" DOUBLE PRECISION,
ADD COLUMN     "longitude" DOUBLE PRECISION,
ADD COLUMN     "provinceId" TEXT,
ADD COLUMN     "regencyId" TEXT,
ADD COLUMN     "skalaPerusahaan" TEXT,
...
-- AlterTable
ALTER TABLE "LaporanPengangkutanFinal" DROP COLUMN "finalisasiPada",
DROP COLUMN "perusahaanId",
DROP COLUMN "totalJumlahB3",
...
-- AlterTable
ALTER TABLE "LaporanPengangkutanFinalDetail" ADD COLUMN     "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- CreateTable
CREATE TABLE "PelaporanPengakutanHistory" (
    "id" TEXT NOT NULL,
    "pelaporanPengakutanId" TEXT NOT NULL,
    "statusPengajuan" TEXT NOT NULL,
    "tanggalPengajuan" TIMESTAMP(3) NOT NULL,
    "tanggalPenyelesaian" TIMESTAMP(3),
    "catatanAdmin" TEXT,
    ...
    CONSTRAINT "PelaporanPengakutanHistory_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "LaporanPengangkutanFinal_applicationId_companyId_bulan_tahu_key" ON "LaporanPengangkutanFinal"("applicationId", "companyId", "bulan", "tahun");
...
-- AddForeignKey
ALTER TABLE "Company" ADD CONSTRAINT "Company_provinceId_fkey" FOREIGN KEY ("provinceId") REFERENCES "reg_provinces"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Company" ADD CONSTRAINT "Company_regencyId_fkey" FOREIGN KEY ("regencyId") REFERENCES "reg_regencies"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Company" ADD CONSTRAINT "Company_districtId_fkey" FOREIGN KEY ("districtId") REFERENCES "reg_districts"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Company" ADD CONSTRAINT "Company_villageId_fkey" FOREIGN KEY ("villageId") REFERENCES "reg_village"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "LaporanPengangkutanFinal" ADD CONSTRAINT "LaporanPengangkutanFinal_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES "Company"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "LaporanPengangkutanFinal" ADD CONSTRAINT "LaporanPengangkutanFinal_vehicleId_fkey" FOREIGN KEY ("vehicleId") REFERENCES "Vehicle"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "LaporanPengangkutanFinal" ADD CONSTRAINT "LaporanPengangkutanFinal_periodId_fkey" FOREIGN KEY ("periodId") REFERENCES "Period"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "PelaporanPengakutanHistory" ADD CONSTRAINT "PelaporanPengakutanHistory_pelaporanPengakutanId_fkey" FOREIGN KEY ("pelaporanPengakutanId") REFERENCES "PelaporanPengangkutan"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
