...
export class DraftSuratNotifikasiController {
  ...
  @ApiBody({
    ...
    examples: {
      example1: {
        summary: 'Update Explicit Consent Draft Example',
        value: {
          nomorSurat: '123/ABC/2024',
          tanggalSurat: '2024-01-01',
    ...
    examples: {
      example1: {
        ...
        value: {
          ...
          customPoint1: 'Details on import specifications',
          customPoint2: 'Additional context and requirements',
          customPoint3: 'Certification of compliance',
          customPoint4: 'Handling and transport precautions',
  ...
  @ApiResponse({
    ...
    schema: {
      example: {
        ...
        tanggalSurat: '2024-10-30T00:00:00Z',
        tipeSurat: 'Explicit Consent and Persetujuan ECHA',
        point1: 'Details on import specifications',
        point2: 'Additional context and requirements',
        point3: 'Certification of compliance',
        point4: 'Handling and transport precautions',
        echaSpecificData: 'ECHA-related information here',
        validitasSurat: '2024-12-31T00:00:00Z',
        referenceNumber: 'REF123456',
        negaraAsal: 'Indonesia',
    ...
    examples: {
      example1: {
        ...
        value: {
          ...
          customPoint1: 'Updated details on import specifications',
          customPoint2: 'Updated additional context and requirements',
          customPoint3: 'Updated certification of compliance',
          customPoint4: 'Updated handling and transport precautions',
